...
export const UI: Record<Language, UIStrings> = {
  ...
  de: {
    ...
    shareStoryWithUs: 'Teilen Sie eine Geschichte der Güte mit uns!',
  ...
  nl: {
    ...
    shareStoryWithUs: 'Deel een verhaal van goedheid met ons!',
  ...
  es: {
    ...
    shareStoryWithUs: '¡Comparte una historia de bondad con nosotros!',
  ...
  fr: {
    ...
    shareStoryWithUs: 'Partagez une histoire de bonté avec nous !',
  ...
  pl: {
    ...
    shareStoryWithUs: 'Podziel się z nami historią dobroci!',
  ...
  pt: {
    ...
    shareStoryWithUs: 'Compartilhe uma história de bondade conosco!',
  ...
  ja: {
    ...
    shareStory: 'ストーリーを共有',
    shareStoryWithUs: '善意の物語を私たちと共有しよう！',
  ...
  sr: {
    ...
    shareStoryWithUs: 'Podelite priču o dobroti sa nama!',
