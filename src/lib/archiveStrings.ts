...
export type ArchiveSubmitStrings = {
  ...
  // Attestation modal
  attestationThanks: string
  attestationIntro: string
  attestationOriginal: string
  attestationCopyright: string
  attestationPrivacy: string
  attestationHuman: string
  attestationTrue: string
  attestationNoCompensation: string
  attestationNoEdits: string
  attestationEditorial: string
  attestationCheckbox: string
  attestationConfirm: string
  attestationCancel: string
  // Validation errors
...
export const ARCHIVE_SUBMIT_EN: ArchiveSubmitStrings = {
  ...
  attestationThanks: "Thank you for sharing your story with us — it's very kind of you to take the time to share goodness with all of us.",
  ...
  attestationNoCompensation: "You understand this is a volunteer contribution with no payment — if published, you'll be credited using the name you provide unless you choose Anonymous.",
  ...
  attestationConfirm: 'Confirm & Submit',
  attestationCancel: 'Cancel',
