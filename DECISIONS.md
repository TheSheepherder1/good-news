...
19. ~~**Submitted story open/close behavior**~~ — DONE.
...
33. ~~**Review archive submission notes and agreement**~~ — DONE. Attestation modal added to `/archive/submit` with full agreement text; all terms reviewed and updated.
35. **Marketing — radio, TV, and press outreach** — pursue interviews tied to the World Cup origin story. Core pitch: "I built a site to capture the goodness I witnessed at the World Cup, and now people from around the world are sharing their own stories of goodness in 74 languages." Targets: local TV morning shows, positivity/wellbeing podcasts, human-interest radio. Supporting pieces to have ready before outreach: (a) an "Our Story" page telling the World Cup origin story for journalists to anchor on, (b) a strong set of live archive stories so any traffic spike lands on substance, (c) newsletter signup (to-do #21) as the capture mechanism for listeners who visit once.
