...
22. **Social media accounts + site links** — create The Good I Found accounts on Instagram, Facebook, and potentially Bluesky/X. Once created, add social links to the site footer alongside the existing Ko-fi and About links. Accounts can be used to cross-post stories and grow readership back to the site.
